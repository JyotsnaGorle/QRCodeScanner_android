...
//        findViewById(R.id.btn_send_value).setEnabled(false);

        findViewById(R.id.btn_send_value).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // send data to esp32 server
                // Instantiate the RequestQueue.
                RequestQueue queue = Volley.newRequestQueue(getApplicationContext());
                // param1 - mac_address, param2 - new_root_scanned.
                String url ="http://192.168.2.113/index.html?param1=" + barcodeValue;
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Log.d("HTTP", "HTTP: Response is: "+ response.substring(0,11));
                            }
                        }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Log.d("HTTP", "HTTP: That didn't work!" + error.toString());
                    }
                });
        ...
        if(mCamera != null) {
            ...
            camCallback.setBarcodeDetectedListener(new OnBarcodeListener() {
                ...
                public void onIsbnDetected(FirebaseVisionBarcode barcode) {
                    ...
                    findViewById(R.id.btn_send_value).setEnabled(true);
                    overlay.invalidate();
                }
            });
